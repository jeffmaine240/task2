...
from ..models import User, Organization # Adjust with your actual path to models
...
class TestAuth(TestCase):
    ...
    def test_register_user_success(self):
        ...
        self.assertEqual(org.name, f"{self.user_data['first_name']}'s Organisation")
    ...
    def test_register_missing_fields(self):
        ...
        data = response.json()
        self.assertEqual(data['errors'][0]['field'], 'first_name')
